...
public class BaseCharacter : MonoBehaviour {
	...
	private int baseMagicalDamage;// (special attack)
	private int magicalResistance;
	private int baseMagicalResistance;// (special defence)
	private int speed;
	...
	public int BaseMagicalResistance {get; set;}
	...
	public BaseCharacter (){
		...
		BaseAttack = 30;
		BaseDefense = 30;
		BaseMagicalDamage = 30;
		BaseMagicalResistance = 30;
		BaseSpeed = 30;
...
//	}
	...
	void UpdateStats (string stat, float percent){
		...
		case "Defense":
			...
			break;
		case "MagicalDamage":
			MagicalDamage += (int)(BaseMagicalDamage * percent);
			break;
		case "MagicalResistance":
			MagicalResistance += (int)(BaseMagicalResistance * percent);
			break;
		case "Speed":
	...
	public void UpdateBaseStats (string stat, int change){
		...
		case "Defense":
			...
			break;
		case "MagicalDamage":
			BaseMagicalDamage += change;
			break;
		case "MagicalResistance":
			BaseMagicalResistance += change;
			break;
		case "Speed":
			BaseSpeed += change;
			break;
	...
	public void ResetStats (){
		...
		MagicalResistance = BaseMagicalResistance;
		Speed = BaseSpeed;
